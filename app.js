...
*/
game.party.push(pokemon[5], pokemon[2], pokemon[3]);
...
game.party.forEach((start, index) => {
  if (start.starter === true) {
    game.party.splice(index, 1, pokemon[index + 1]);
  }
});
...
game.catchPokemon = function catchPokemon(pokemonObj) {
  game.party.push(pokemonObj);
  let t = game.items[1].quantity;
  game.items[1].quantity = t + -1;
};
...
*/
console.log(game);
//console.dir(pokemon, { maxArrayLenght: null });
